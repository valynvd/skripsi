...
const CreateForm = ({ isOpen, handleClose }) => {
  ...
  const handleSubmit = () => {
    ...
    dataForm.append('file_panduan_kurikulum', panduanKurikulum);
    dataForm.append('file_pendukung', pendukung);

    dataApi.postKurikulum(dataForm).then((resp) => {
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="card__title">
                    ...
                    <h5 className="subhead">Kurikulum</h5>
                  </div>
                    ...
                    <div className="form__form-group">
                      ...
                      <div className="form__form-group-field">
                        <Field
                          ...
                          onChange={(e) => setPanduanKurikulum(e.file)}
                        />
                      </div>
                    </div>
                    <div className="form__form-group">
                      ...
                      <div className="form__form-group-field">
                        <Field
                          name="file_pendukung"
                          component={renderFileInputField}
                          onChange={(e) => setPendukung(e.file)}
                        />
                      </div>
                    </div>
