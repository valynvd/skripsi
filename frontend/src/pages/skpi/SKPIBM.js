...
const SKPIBM = () => {
  ...
  const generatePDFSKPI = (
    ...
    justifyText(
      doc,
      'Capaian pembelajaran lulusan program studi Matematika pada program sarjana, Universitas Prasetiya Mulya mengacu kepada Kerangka Kualifikasi Nasional Indonesia (KKNI) Level 6 sebagai syarat minimal kelulusan:',
      boxX,
      boldTextY,
      pageWidth - 30,
    ...
    justifyText(
      doc,
      'Learning outcomes of the undergraduate program in Mathematics, Universitas Prasetiya Mulya refer to the Indonesian Qualification Framework Level 6 as minimum requirements for completion:',
      boxX,
      italicTextY,
      pageWidth - 30,
      doc.internal.getFontSize() / 2
    ...
    doc.setFont('Calibri', 'bold');
    doc.text(
      'Lulusan program studi Matematika pada program sarjana, Universitas Prasetiya Mulya:',
      boxX,
      newBoldTextY,
      {
    ...
    doc.setFont('Calibri', 'italic');
    doc.text(
      'Graduates of the undergraduate program in Mathematics, Universitas Prasetiya Mulya:',
      boxX,
      newItalicTextY,
      {
        maxWidth: pageWidth - 30,
    ...
    const tableData1 = [
      [
        ...
        finalCPLScores['CPL-BM-S1']
          ? finalCPLScores['CPL-BM-S1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.2',
        ...
        finalCPLScores['CPL-BM-S2']
          ? finalCPLScores['CPL-BM-S2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableData2 = [
      [
        ...
        finalCPLScores['CPL-BM-S3']
          ? finalCPLScores['CPL-BM-S3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.4',
        ...
        finalCPLScores['CPL-BM-S4']
          ? finalCPLScores['CPL-BM-S4'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.5',
        ...
        finalCPLScores['CPL-BM-S5']
          ? finalCPLScores['CPL-BM-S5'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.6',
        ...
        finalCPLScores['CPL-BM-S6']
          ? finalCPLScores['CPL-BM-S6'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanUmum = [
      [
        ...
        finalCPLScores['CPL-BM-KU1']
          ? finalCPLScores['CPL-BM-KU1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.B.2',
        ...
        finalCPLScores['CPL-BM-KU2']
          ? finalCPLScores['CPL-BM-KU2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanUmum2 = [
      [
        ...
        finalCPLScores['CPL-BM-KU3']
          ? finalCPLScores['CPL-BM-KU3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.B.4',
        ...
        finalCPLScores['CPL-BM-KU4']
          ? finalCPLScores['CPL-BM-KU4'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataPengetahuan = [
      [
        '3.C.1',
        'Menguasai konsep teoritis matematika dan statistika meliputi logika matematika, matematika diskret, aljabar, analisis dan geometri, peluang, dan serta teori statistika;',
        'Master the theoretical concepts of mathematics and statistics which includes mathematical logic, discrete mathematics, algebra, analysis and geometry, probability, and statistical theory;',
        finalCPLScores['CPL-BM-P1']
          ? finalCPLScores['CPL-BM-P1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.C.2',
        'Menguasai prinsip-prinsip pemodelan matematika dan statistika, seperti program linear, persamaan diferensial, metode numerik, regresi, analisis data, dan analisis data deret waktu;',
        'Master the principles of mathematical  and statistical modeling such as linear programming, differential equation, numerical methods, regression, data analysis, and time series analysis;',
        finalCPLScores['CPL-BM-P2']
          ? finalCPLScores['CPL-BM-P2'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.C.3',
        'Menguasai pemrograman, komputasi, dan simulasi matematika dan statistika;',
        'Master the programming, computation, and mathematical and statistical simulation;',
        finalCPLScores['CPL-BM-P3']
          ? finalCPLScores['CPL-BM-P3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.C.4',
        'Menguasai prinsip-prinsip dasar ekonomi dan keuangan seperti mikro dan makro ekonomi, akutansi, dan manajemen keuangan;',
        'Master the principles of economy and finance such as micro and macroeconomics, accounting, and financial management;',
        finalCPLScores['CPL-BM-P4']
          ? finalCPLScores['CPL-BM-P4'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataPengetahuan2 = [
      [
        '3.C.5',
        'Menguasai prinsip-prinsip dasar inovasi dan kewirausahaan.',
        'Master the basic principles of innovation and enterpreunership.',
        finalCPLScores['CPL-BM-P5']
          ? finalCPLScores['CPL-BM-P5'].toFixed(2)
          : 'N/A',
      ],
    ];

    const tableDataPengetahuan2Y = 35;
    let rowDataPengetahuanY2 = tableDataPengetahuan2Y;

    // Print Table Data
    const cellPaddingPengetahuan2 = 3;
    ...
    tableDataPengetahuan2.forEach((row) => {
      ...
      if (rowDataPengetahuanY2 + rowHeight > pageHeight - 40) {
        addPageWithHeader();
        rowDataPengetahuanY2 = 20;
      }
      ...
      row.forEach((cell, i) => {
        ...
        if (
          isNaN(cellX) ||
          isNaN(rowDataPengetahuanY2) ||
          isNaN(cellWidth) ||
          isNaN(rowHeight)
        ) {
          console.error('Invalid values:', {
            cellX,
            rowDataPengetahuanY2,
            cellWidth,
            rowHeight,
          });
          return;
        ...
        doc.rect(cellX, rowDataPengetahuanY2, cellWidth, rowHeight);
        ...
        // Justify text
        let currentY = rowDataPengetahuanY2 + cellPaddingPengetahuan2 + 5;
        justifyText(
          doc,
          cell,
      ...
      rowDataPengetahuanY2 += rowHeight;
    });

    // D. Keterampilan Khusus
    let newSectionKeterampilanKhusus = rowDataPengetahuanY2 + 15;
    ...
    const tableDataKeterampilanKhusus = [
      [
        ...
        'Are able to develop mathematical thinking consists of procedural/mathematical understanding to a broad understanding that includes exploration, logical reasoning, generalization, abstraction, and formal proofs;',
        finalCPLScores['CPL-BM-KK1']
          ? finalCPLScores['CPL-BM-KK1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.2',
        ...
        'Are able to observe, identify, formulize, and solve problems through mathematical approaches with or without software assistance;',
        finalCPLScores['CPL-BM-KK2']
          ? finalCPLScores['CPL-BM-KK2'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.3',
        'Mampu merekonstruksi, memodifikasi, menganalisis/ berpikir secara terstruktur terhadap permasalahan matematis dari suatu fenomena, mengkaji keakuratan dan mengintepretasikannya serta mengkomunikasikan secara lisan maupun tertulis dengan tepat, dan jelas;',
        'Are able to reconstruct, to modify, and to analyze mathematical problems of phenomena in a structured framework, to assess its accuracy and to interpret and communicate them orally and in writing clearly and precisely;',
        finalCPLScores['CPL-BM-KK3']
          ? finalCPLScores['CPL-BM-KK3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.4',
        ...
        'Are able to implement various alternative solutions to mathematical problems that are available, in person or in a group, to make appropriate decision.',
        finalCPLScores['CPL-BM-KK4']
          ? finalCPLScores['CPL-BM-KK4'].toFixed(2)
          : 'N/A',
      ],
    ];
      ...
      <div ref={pdfRef}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="w-2/3 py-2">
                  <input
                    className={`accent-primary-400 focus:outline-none w-full mt-1 rounded-lg px-3 py-2 focus:border-primary-400 border-[1px]`}
                    value="Sarjana Matematika (S.Mat.)"
                    readOnly
                  />
                </td>
              </tr>
        ...
        <div id="informasi-pribadi" className=" my-8 mt-4">
          ...
          <h2 className="text-lg font-semibold">
            Capaian pembelajaran lulusan program studi Matematika pada program
            sarjana, Universitas Prasetiya Mulya mengacu kepada Kerangka
            Kualifikasi Nasional Indonesia (KKNI) Level 6 sebagai syarat minimal
            kelulusan:
          </h2>
          <p className="italic mb-4">
            Learning outcomes of the undergraduate program in Mathematics,
            Universitas Prasetiya Mulya refer to the Indonesian Qualification
            Framework Level 6 as minimum requirements for completion:
          </p>
          ...
          <div>
            ...
            <h3 className="text-lg font-semibold mt-8">
              Lulusan program studi Matematika pada program sarjana, Universitas
              Prasetiya Mulya:
            </h3>
            <p className="italic">
              Graduates of undergraduate program in Mathematics, Universitas
              Prasetiya Mulya:
            </p>
              ...
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    ...
                    onClick={() => handleCPLClick('CPL-BM-S1')}
                  >
                    {finalCPLScores['CPL-BM-S1']
                      ? finalCPLScores['CPL-BM-S1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-S2')}
                  >
                    {finalCPLScores['CPL-BM-S2']
                      ? finalCPLScores['CPL-BM-S2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-S3')}
                  >
                    {finalCPLScores['CPL-BM-S3']
                      ? finalCPLScores['CPL-BM-S3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-S4')}
                  >
                    {finalCPLScores['CPL-BM-S4']
                      ? finalCPLScores['CPL-BM-S4'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-S5')}
                  >
                    {finalCPLScores['CPL-BM-S5']
                      ? finalCPLScores['CPL-BM-S5'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-S6')}
                  >
                    {finalCPLScores['CPL-BM-S6']
                      ? finalCPLScores['CPL-BM-S6'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KU1')}
                  >
                    {finalCPLScores['CPL-BM-KU1']
                      ? finalCPLScores['CPL-BM-KU1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KU2')}
                  >
                    {finalCPLScores['CPL-BM-KU2']
                      ? finalCPLScores['CPL-BM-KU2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KU3')}
                  >
                    {finalCPLScores['CPL-BM-KU3']
                      ? finalCPLScores['CPL-BM-KU3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KU4')}
                  >
                    {finalCPLScores['CPL-BM-KU4']
                      ? finalCPLScores['CPL-BM-KU4'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Menguasai konsep teoritis matematika dan statistika meliputi
                    logika matematika, matematika diskret, aljabar, analisis dan
                    geometri, peluang, dan serta teori statistika;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Master the theoretical concepts of mathematics and
                    statistics which includes mathematical logic, discrete
                    mathematics, algebra, analysis and geometry, probability,
                    and statistical theory;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-P1')}
                  >
                    {finalCPLScores['CPL-BM-P1']
                      ? finalCPLScores['CPL-BM-P1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Menguasai prinsip-prinsip pemodelan matematika dan
                    statistika, seperti program linear, persamaan diferensial,
                    metode numerik, regresi, analisis data, dan analisis data
                    deret waktu;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Master the principles of mathematical and statistical
                    modeling such as linear programming, differential equation,
                    numerical methods, regression, data analysis, and time
                    series analysis;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-P2')}
                  >
                    {finalCPLScores['CPL-BM-P2']
                      ? finalCPLScores['CPL-BM-P2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Menguasai pemrograman, komputasi, dan simulasi matematika
                    dan statistika;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Master the programming, computation, and mathematical and
                    statistical simulation;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-P3')}
                  >
                    {finalCPLScores['CPL-BM-P3']
                      ? finalCPLScores['CPL-BM-P3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Menguasai prinsip-prinsip dasar ekonomi dan keuangan seperti
                    mikro dan makro ekonomi, akutansi, dan manajemen keuangan;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Master the principles of economy and finance such as micro
                    and macroeconomics, accounting, and financial management;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-P4')}
                  >
                    {finalCPLScores['CPL-BM-P4']
                      ? finalCPLScores['CPL-BM-P4'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-6/12 p-2 italic">
                    Master the basic principles of innovation and
                    enterpreunership.
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-P5')}
                  >
                    {finalCPLScores['CPL-BM-P5']
                      ? finalCPLScores['CPL-BM-P5'].toFixed(2)
                      : 'N/A'}
              ...
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    ...
                    meliputi eksplorasi, penalaran logis, generalisasi,
                    abstraksi, dan bukti formal;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to develop mathematical thinking consists of
                    procedural/mathematical understanding to a broad
                    understanding that includes exploration, logical reasoning,
                    generalization, abstraction, and formal proofs;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KK1')}
                  >
                    {finalCPLScores['CPL-BM-KK1']
                      ? finalCPLScores['CPL-BM-KK1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-6/12 p-2 italic">
                    Are able to observe, identify, formulize, and solve problems
                    through mathematical approaches with or without software
                    assistance;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KK2')}
                  >
                    {finalCPLScores['CPL-BM-KK2']
                      ? finalCPLScores['CPL-BM-KK2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu merekonstruksi, memodifikasi, menganalisis/ berpikir
                    secara terstruktur terhadap permasalahan matematis dari
                    suatu fenomena, mengkaji keakuratan dan
                    mengintepretasikannya serta mengkomunikasikan secara lisan
                    maupun tertulis dengan tepat, dan jelas;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to reconstruct, to modify, and to analyze
                    mathematical problems of phenomena in a structured
                    framework, to assess its accuracy and to interpret and
                    communicate them orally and in writing clearly and
                    precisely;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KK3')}
                  >
                    {finalCPLScores['CPL-BM-KK3']
                      ? finalCPLScores['CPL-BM-KK3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-6/12 p-2 italic">
                    Are able to implement various alternative solutions to
                    mathematical problems that are available, in person or in a
                    group, to make appropriate decision.
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-BM-KK4')}
                  >
                    {finalCPLScores['CPL-BM-KK4']
                      ? finalCPLScores['CPL-BM-KK4'].toFixed(2)
                      : 'N/A'}
