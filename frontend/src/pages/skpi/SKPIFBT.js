...
const SKPIFBT = () => {
  ...
  const generatePDFSKPI = (
    ...
    doc.setFontSize(12);
    titleText('No. 582012021000024/SKPI', 4, 'bold', 12);
    ...
    justifyText(
      doc,
      'Capaian pembelajaran lulusan program studi Teknologi Pangan pada program sarjana, Universitas Prasetiya Mulya mengacu kepada Kerangka Kualifikasi Nasional Indonesia (KKNI) Level 6 sebagai syarat minimal kelulusan:',
      boxX,
      boldTextY,
      pageWidth - 30,
    ...
    justifyText(
      doc,
      'Learning outcomes of the undergraduate program in Food Technology, Universitas Prasetiya Mulya refer to the Indonesian Qualification Framework Level 6 as minimum requirements for completion:',
      boxX,
      italicTextY,
      pageWidth - 30,
      doc.internal.getFontSize() / 2
    ...
    doc.setFont('Calibri', 'bold');
    doc.text(
      'Lulusan program studi Teknologi Pangan pada program sarjana, Universitas Prasetiya Mulya:',
      boxX,
      newBoldTextY,
      {
    ...
    doc.setFont('Calibri', 'italic');
    doc.text(
      'Graduates of the undergraduate program in Food Technology, Universitas Prasetiya Mulya:',
      boxX,
      newItalicTextY,
      {
        maxWidth: pageWidth - 30,
    ...
    const tableData1 = [
      [
        ...
        finalCPLScores['CPL-FBT-S1']
          ? finalCPLScores['CPL-FBT-S1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.2',
        ...
        finalCPLScores['CPL-FBT-S2']
          ? finalCPLScores['CPL-FBT-S2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableData2 = [
      [
        ...
        finalCPLScores['CPL-FBT-S3']
          ? finalCPLScores['CPL-FBT-S3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.4',
        ...
        finalCPLScores['CPL-FBT-S4']
          ? finalCPLScores['CPL-FBT-S4'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.5',
        ...
        finalCPLScores['CPL-FBT-S5']
          ? finalCPLScores['CPL-FBT-S5'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.6',
        ...
        finalCPLScores['CPL-FBT-S6']
          ? finalCPLScores['CPL-FBT-S6'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanUmum = [
      [
        ...
        finalCPLScores['CPL-FBT-KU1']
          ? finalCPLScores['CPL-FBT-KU1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.B.2',
        ...
        finalCPLScores['CPL-FBT-KU2']
          ? finalCPLScores['CPL-FBT-KU2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanUmum2 = [
      [
        ...
        finalCPLScores['CPL-FBT-KU3']
          ? finalCPLScores['CPL-FBT-KU3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.B.4',
        ...
        finalCPLScores['CPL-FBT-KU4']
          ? finalCPLScores['CPL-FBT-KU4'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataPengetahuan = [
      [
        '3.C.1',
        'Mampu menjelaskan konsep-konsep ilmu sains dasar yang merupakan fondasi keilmuan teknologi pangan;',
        'Are able to explain the concepts of basic science that constitute the fundamental principles for food technology;',
        finalCPLScores['CPL-FBT-P1']
          ? finalCPLScores['CPL-FBT-P1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.C.2',
        'Mampu menjelaskan konsep-konsep utama di bidang teknologi pangan (kimia dan analisis pangan, mikrobiologi pangan, keamanan pangan, rekayasa dan pengolahan pangan, biokimia pangan, gizi dan kesehatan, dan ilmu pangan terapan) untuk diformulasikan dalam teknik perancangan proses pangan secara terpadu;',
        'Are able to explain the core subjects in food technology (food chemistry and analysis, food microbiology, food safety, food engineering and processing, food biochemistry, nutrition and health, and applied food science) to produce comprehensive food process design techniques;',
        finalCPLScores['CPL-FBT-P2']
          ? finalCPLScores['CPL-FBT-P2'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.C.3',
        'Mampu menjelaskan prinsip-prinsip bisnis dalam menciptakan bisnis pangan yang berbasis teknologi.',
        'Are able to explain the business principles in creating a technology-based food business.',
        finalCPLScores['CPL-FBT-P3']
          ? finalCPLScores['CPL-FBT-P3'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanKhusus = [
      [
        '3.D.1',
        'Mampu menerapkan keterampilan di bidang sains dan teknologi yang menjadi fondasi dari teknologi pangan;',
        'Are able to apply the basic skills in science and technology essential for studying food technology;',
        finalCPLScores['CPL-FBT-KK1']
          ? finalCPLScores['CPL-FBT-KK1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.2',
        'Mampu menerapkan keilmuan dan teknologi pangan secara terpadu untuk menunjang upaya menghasilkan inovasi proses dan produk pangan unggulan (Smart Healthy Food) pada skala industri;',
        'Are able to apply the food science and technology concepts to develop industrial-scale food product and process innovations (Smart Healthy Food);',
        finalCPLScores['CPL-FBT-KK2']
          ? finalCPLScores['CPL-FBT-KK2'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.3',
        'Mampu menerapkan prinsip-prinsip teknologi pangan dan bisnis dan menggabungkan kedua bidang ini secara sinergis untuk menciptakan bisnis pangan yang berbasis teknologi.',
        'Are able to apply the core concepts of food technology and business, and synthesize both disciplines efficiently to further technology-based food business development.',
        finalCPLScores['CPL-FBT-KK3']
          ? finalCPLScores['CPL-FBT-KK3'].toFixed(2)
          : 'N/A',
      ],
    ];
      ...
      <div ref={pdfRef}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="w-2/3 py-2">
                  <input
                    className={`accent-primary-400 focus:outline-none w-full mt-1 rounded-lg px-3 py-2 focus:border-primary-400 border-[1px]`}
                    value="Sarjana Teknologi Pangan (S.T.P.)"
                    readOnly
                  />
                </td>
              </tr>
        ...
        <div id="informasi-pribadi" className=" my-8 mt-4">
          ...
          <h2 className="text-lg font-semibold">
            Capaian pembelajaran lulusan program studi Teknologi Pangan pada
          ...
          <p className="italic mb-4">
            Learning outcomes of the undergraduate program in Food Technology,
          ...
          <div>
            ...
            <h3 className="text-lg font-semibold mt-8">
              Lulusan program studi Teknologi Pangan pada program sarjana,
              Universitas Prasetiya Mulya:
            </h3>
            <p className="italic">
              Graduates of undergraduate program in Food Technology, Universitas
              Prasetiya Mulya:
            </p>
              ...
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    ...
                    onClick={() => handleCPLClick('CPL-FBT-S1')}
                  >
                    {finalCPLScores['CPL-FBT-S1']
                      ? finalCPLScores['CPL-FBT-S1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-S2')}
                  >
                    {finalCPLScores['CPL-FBT-S2']
                      ? finalCPLScores['CPL-FBT-S2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-S3')}
                  >
                    {finalCPLScores['CPL-FBT-S3']
                      ? finalCPLScores['CPL-FBT-S3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-S4')}
                  >
                    {finalCPLScores['CPL-FBT-S4']
                      ? finalCPLScores['CPL-FBT-S4'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-S5')}
                  >
                    {finalCPLScores['CPL-FBT-S5']
                      ? finalCPLScores['CPL-FBT-S5'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-S6')}
                  >
                    {finalCPLScores['CPL-FBT-S6']
                      ? finalCPLScores['CPL-FBT-S6'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KU1')}
                  >
                    {finalCPLScores['CPL-FBT-KU1']
                      ? finalCPLScores['CPL-FBT-KU1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KU2')}
                  >
                    {finalCPLScores['CPL-FBT-KU2']
                      ? finalCPLScores['CPL-FBT-KU2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KU3')}
                  >
                    {finalCPLScores['CPL-FBT-KU3']
                      ? finalCPLScores['CPL-FBT-KU3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KU4')}
                  >
                    {finalCPLScores['CPL-FBT-KU4']
                      ? finalCPLScores['CPL-FBT-KU4'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menjelaskan konsep-konsep ilmu sains dasar yang
                    merupakan fondasi keilmuan teknologi pangan;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to explain the concepts of basic science that
                    constitute the fundamental principles for food technology;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-P1')}
                  >
                    {finalCPLScores['CPL-FBT-P1']
                      ? finalCPLScores['CPL-FBT-P1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menjelaskan konsep-konsep utama di bidang teknologi
                    pangan (kimia dan analisis pangan, mikrobiologi pangan,
                    keamanan pangan, rekayasa dan pengolahan pangan, biokimia
                    pangan, gizi dan kesehatan, dan ilmu pangan terapan) untuk
                    diformulasikan dalam teknik perancangan proses pangan secara
                    terpadu;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to explain the core subjects in food technology
                    (food chemistry and analysis, food microbiology, food
                    safety, food engineering and processing, food biochemistry,
                    nutrition and health, and applied food science) to produce
                    comprehensive food process design techniques;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-P2')}
                  >
                    {finalCPLScores['CPL-FBT-P2']
                      ? finalCPLScores['CPL-FBT-P2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menjelaskan prinsip-prinsip bisnis dalam menciptakan
                    bisnis pangan yang berbasis teknologi.
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to explain the business principles in creating a
                    technology-based food business.
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-P3')}
                  >
                    {finalCPLScores['CPL-FBT-P3']
                      ? finalCPLScores['CPL-FBT-P3'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menerapkan keterampilan di bidang sains dan teknologi
                    yang menjadi fondasi dari teknologi pangan;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to apply the basic skills in science and technology
                    essential for studying food technology;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KK1')}
                  >
                    {finalCPLScores['CPL-FBT-KK1']
                      ? finalCPLScores['CPL-FBT-KK1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menerapkan keilmuan dan teknologi pangan secara
                    terpadu untuk menunjang upaya menghasilkan inovasi proses
                    dan produk pangan unggulan (Smart Healthy Food) pada skala
                    industri;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to apply the food science and technology concepts
                    to develop industrial-scale food product and process
                    innovations (Smart Healthy Food);
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KK2')}
                  >
                    {finalCPLScores['CPL-FBT-KK2']
                      ? finalCPLScores['CPL-FBT-KK2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menerapkan prinsip-prinsip teknologi pangan dan bisnis
                    dan menggabungkan kedua bidang ini secara sinergis untuk
                    menciptakan bisnis pangan yang berbasis teknologi.
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to apply the core concepts of food technology and
                    business, and synthesize both disciplines efficiently to
                    further technology-based food business development.
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-FBT-KK3')}
                  >
                    {finalCPLScores['CPL-FBT-KK3']
                      ? finalCPLScores['CPL-FBT-KK3'].toFixed(2)
                      : 'N/A'}
