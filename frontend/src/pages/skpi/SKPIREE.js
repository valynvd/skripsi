...
const SKPIREE = () => {
  ...
  const generatePDFSKPI = (
    ...
    justifyText(
      doc,
      'Capaian pembelajaran lulusan program studi Teknologi Energi Terbarukan pada program sarjana, Universitas Prasetiya Mulya mengacu kepada Kerangka Kualifikasi Nasional Indonesia (KKNI) Level 6 sebagai syarat minimal kelulusan:',
      boxX,
      boldTextY,
      pageWidth - 30,
    ...
    justifyText(
      doc,
      'Learning outcomes of the undergraduate program in Renewable Energy Engineering, Universitas Prasetiya Mulya refer to the Indonesian Qualification Framework Level 6 as minimum requirements for completion:',
      boxX,
      italicTextY,
      pageWidth - 30,
      doc.internal.getFontSize() / 2
    ...
    doc.setFont('Calibri', 'bold');
    doc.text(
      'Lulusan program studi Teknologi Energi Terbarukan pada program sarjana, Universitas Prasetiya Mulya:',
      boxX,
      newBoldTextY,
      {
    ...
    doc.setFont('Calibri', 'italic');
    doc.text(
      'Graduates of the undergraduate program in Renewable Energy Engineering, Universitas Prasetiya Mulya:',
      boxX,
      newItalicTextY,
      {
        maxWidth: pageWidth - 30,
    ...
    const tableData1 = [
      [
        ...
        finalCPLScores['CPL-REE-S1']
          ? finalCPLScores['CPL-REE-S1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.2',
        ...
        finalCPLScores['CPL-REE-S2']
          ? finalCPLScores['CPL-REE-S2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableData2 = [
      [
        ...
        finalCPLScores['CPL-REE-S3']
          ? finalCPLScores['CPL-REE-S3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.4',
        ...
        finalCPLScores['CPL-REE-S4']
          ? finalCPLScores['CPL-REE-S4'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.5',
        ...
        finalCPLScores['CPL-REE-S5']
          ? finalCPLScores['CPL-REE-S5'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.A.6',
        ...
        finalCPLScores['CPL-REE-S6']
          ? finalCPLScores['CPL-REE-S6'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanUmum = [
      [
        ...
        finalCPLScores['CPL-REE-KU1']
          ? finalCPLScores['CPL-REE-KU1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.B.2',
        ...
        finalCPLScores['CPL-REE-KU2']
          ? finalCPLScores['CPL-REE-KU2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanUmum2 = [
      [
        ...
        finalCPLScores['CPL-REE-KU3']
          ? finalCPLScores['CPL-REE-KU3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.B.4',
        ...
        finalCPLScores['CPL-REE-KU4']
          ? finalCPLScores['CPL-REE-KU4'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataPengetahuan = [
      [
        '3.C.1',
        'Menguasai pengetahuan dasar di bidang teknik energi;',
        'Master basics knowledge of energy engineering;',
        finalCPLScores['CPL-REE-P1']
          ? finalCPLScores['CPL-REE-P1'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.C.2',
        'Mampu menganalisis informasi dan data eksperimentasi dalam perumusan masalah kompleks yang berhubungan dengan energi terbarukan.',
        'Are able to analyze information and experimental data in the formulation of complex problems related to renewable energy.',
        finalCPLScores['CPL-REE-P2']
          ? finalCPLScores['CPL-REE-P2'].toFixed(2)
          : 'N/A',
      ],
    ];
    ...
    const tableDataKeterampilanKhusus = [
      [
        '3.D.1',
        'Menguasai pengetahuan teknik sesuai bidang keahliannya khususnya energi terbarukan;',
        'Master technical knowledge in their respective field, especially renewable energy;',
        finalCPLScores['CPL-REE-KK1']
          ? finalCPLScores['CPL-REE-KK1'].toFixed(2)
          : 'N/A',
      ],
    ];

    const tableStartKeterampilanKhususY = newBoldTextKeterampilanKhusus + 10;
    ...
    const tableDataKeterampilanKhusus2 = [
      [
        '3.D.2',
        'Mampu merumuskan dan memberikan solusi yang tepat terhadap permasalahan kompleks yang berhubungan dengan energi terbarukan;',
        'Are able to formulate and provide proper solutions to complex problems related to renewable energy;',
        finalCPLScores['CPL-REE-KK2']
          ? finalCPLScores['CPL-REE-KK2'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.3',
        'Memiliki kemampuan berinovasi;',
        'Have an ability to innovate;',
        finalCPLScores['CPL-REE-KK3']
          ? finalCPLScores['CPL-REE-KK3'].toFixed(2)
          : 'N/A',
      ],
      [
        '3.D.4',
        'Mampu membuat prototipe produk energi terbarukan sesuai bidang keahlian yang dipilih.',
        'Are able to make prototypes of renewable energy products in their chosen field.',
        finalCPLScores['CPL-REE-KK4']
          ? finalCPLScores['CPL-REE-KK4'].toFixed(2)
          : 'N/A',
      ],
    ];

    // let newBoldTextKeterampilanKhusus2 = 35;
    // if (newBoldTextKeterampilanKhusus2 > pageHeight - 40) {
    //   addPageWithHeader();
    //   newBoldTextKeterampilanKhusus2 = 20;
    // }

    const tableStartKeterampilanKhususY2 = 35;
    if (tableStartKeterampilanKhususY2 > pageHeight - 40) {
      addPageWithHeader();
    }

    // Print Table Data
    const cellPaddingKeterampilanKhusus2 = 3;
    const colWidthsKeterampilanKhusus2 = [15, 75, 75, 15];
    const lineHeightKeterampilanKhusus2 = doc.internal.getFontSize() / 2;

    let rowKeterampilanKhususY2 = tableStartKeterampilanKhususY2;
    ...
    tableDataKeterampilanKhusus2.forEach((row) => {
      ...
      if (rowKeterampilanKhususY2 + rowHeight > pageHeight - 40) {
        addPageWithHeader();
        rowKeterampilanKhususY2 = 20;
      }
      ...
      row.forEach((cell, i) => {
        ...
        if (
          isNaN(cellX) ||
          isNaN(rowKeterampilanKhususY2) ||
          isNaN(cellWidth) ||
          isNaN(rowHeight)
        ) {
          console.error('Invalid values:', {
            cellX,
            rowKeterampilanKhususY2,
            cellWidth,
            rowHeight,
          });
          return;
        ...
        doc.rect(cellX, rowKeterampilanKhususY2, cellWidth, rowHeight);
        ...
        // Justify text
        let currentY =
          rowKeterampilanKhususY2 + cellPaddingKeterampilanKhusus2 + 5;
        justifyText(
          doc,
          cell,
      ...
      rowKeterampilanKhususY2 += rowHeight;
    });

    let afterTableY = rowKeterampilanKhususY2 + 10;
      ...
      <div ref={pdfRef}>
        ...
        <div id="informasi-pribadi" className=" my-8 mt-4">
          ...
          <h2 className="text-lg font-semibold">
            Capaian pembelajaran lulusan program studi Teknologi Energi
            Terbarukan pada program sarjana, Universitas Prasetiya Mulya mengacu
            kepada Kerangka Kualifikasi Nasional Indonesia (KKNI) Level 6
            sebagai syarat minimal kelulusan:
          </h2>
          <p className="italic mb-4">
            Learning outcomes of the undergraduate program in Renewable Energy
          ...
          <div>
            ...
            <h3 className="text-lg font-semibold mt-8">
              Lulusan program studi Teknologi Energi Terbarukan pada program
              sarjana, Universitas Prasetiya Mulya:
            </h3>
            <p className="italic">
              Graduates of undergraduate program in Renewable Energy
              ...
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    ...
                    onClick={() => handleCPLClick('CPL-REE-S1')}
                  >
                    {finalCPLScores['CPL-REE-S1']
                      ? finalCPLScores['CPL-REE-S1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-S2')}
                  >
                    {finalCPLScores['CPL-REE-S2']
                      ? finalCPLScores['CPL-REE-S2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-S3')}
                  >
                    {finalCPLScores['CPL-REE-S3']
                      ? finalCPLScores['CPL-REE-S3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-S4')}
                  >
                    {finalCPLScores['CPL-REE-S4']
                      ? finalCPLScores['CPL-REE-S4'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-S5')}
                  >
                    {finalCPLScores['CPL-REE-S5']
                      ? finalCPLScores['CPL-REE-S5'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-S6')}
                  >
                    {finalCPLScores['CPL-REE-S6']
                      ? finalCPLScores['CPL-REE-S6'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KU1')}
                  >
                    {finalCPLScores['CPL-REE-KU1']
                      ? finalCPLScores['CPL-REE-KU1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KU2')}
                  >
                    {finalCPLScores['CPL-REE-KU2']
                      ? finalCPLScores['CPL-REE-KU2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KU3')}
                  >
                    {finalCPLScores['CPL-REE-KU3']
                      ? finalCPLScores['CPL-REE-KU3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KU4')}
                  >
                    {finalCPLScores['CPL-REE-KU4']
                      ? finalCPLScores['CPL-REE-KU4'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-P1')}
                  >
                    {finalCPLScores['CPL-REE-P1']
                      ? finalCPLScores['CPL-REE-P1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu menganalisis informasi dan data eksperimentasi dalam
                    perumusan masalah kompleks yang berhubungan dengan energi
                    terbarukan.
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to analyze information and experimental data in the
                    formulation of complex problems related to renewable energy.
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-P2')}
                  >
                    {finalCPLScores['CPL-REE-P2']
                      ? finalCPLScores['CPL-REE-P2'].toFixed(2)
                      : 'N/A'}
            ...
            <table className="w-full mt-8 border-collapse border border-gray-400">
              <tbody className="align-top">
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Menguasai pengetahuan teknik sesuai bidang keahliannya
                    khususnya energi terbarukan;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Master technical knowledge in their respective field,
                    especially renewable energy;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KK1')}
                  >
                    {finalCPLScores['CPL-REE-KK1']
                      ? finalCPLScores['CPL-REE-KK1'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu merumuskan dan memberikan solusi yang tepat terhadap
                    permasalahan kompleks yang berhubungan dengan energi
                    terbarukan;
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to formulate and provide proper solutions to
                    complex problems related to renewable energy;
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KK2')}
                  >
                    {finalCPLScores['CPL-REE-KK2']
                      ? finalCPLScores['CPL-REE-KK2'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KK3')}
                  >
                    {finalCPLScores['CPL-REE-KK3']
                      ? finalCPLScores['CPL-REE-KK3'].toFixed(2)
                      : 'N/A'}
                ...
                <tr className="border">
                  ...
                  <td className="border w-5/12 p-2">
                    Mampu membuat prototipe produk energi terbarukan sesuai
                    bidang keahlian yang dipilih.
                  </td>
                  <td className="border w-6/12 p-2 italic">
                    Are able to make prototypes of renewable energy products in
                    their chosen field.
                  </td>
                  <td
                    className="border w-1/12 p-2 cursor-pointer font-bold text-primary-400"
                    onClick={() => handleCPLClick('CPL-REE-KK4')}
                  >
                    {finalCPLScores['CPL-REE-KK4']
                      ? finalCPLScores['CPL-REE-KK4'].toFixed(2)
                      : 'N/A'}
