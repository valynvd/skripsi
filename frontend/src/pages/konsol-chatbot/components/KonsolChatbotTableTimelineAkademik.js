...
const KonsolChatbotTableTimelineAkademik = ({
  setOpenModalDelete,
  setSelectedItem,
  loading,
  data,
      ...
      Cell: ({
        ...
        return (
          <div className="flex flex-row space-x-2">
            <EditIcon
              onClick={() => {
                navigate(`/stem-chatbot/konsol-chatbot/timelineakademik/${value._id}`, {
                  state: value,
                });
              }}
            />
...
export default KonsolChatbotTableTimelineAkademik;
