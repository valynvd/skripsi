...
import { useMonitoringMahasiswaDataByNIM, useDeleteMonitoringMahasiswa } from '../../hooks/useMonitoringMahasiswa';
import MonitoringMahasiswaTable from './components/MonitoringMahasiswaTable';
import { useQueryClient } from 'react-query';

const MonitoringMahasiswaByNIM = () => {
  ...
  const { data: responseData, isLoading, refetch: dataMahasiswaRefetch } = useMonitoringMahasiswaDataByNIM(nim);
...
export default MonitoringMahasiswaByNIM;